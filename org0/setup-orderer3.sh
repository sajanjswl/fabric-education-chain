...
mkdir -p orderers/orderer3/assets/ca
mkdir  orderers/orderer3/assets/tls-ca
sleep 2s
cp ./ca/server/crypto/ca-cert.pem ./orderers/orderer3/assets/ca/org0-ca-cert.pem
cp ../TLS-CA/server/crypto/ca-cert.pem ./orderers/orderer3/assets/tls-ca/tls-ca-cert.pem
sleep 2s
#################################################################
...
export FABRIC_CA_CLIENT_HOME=./orderers/orderer3
...
echo "                                                                 "
echo "#################################################################"
echo "################ orderer3-org0 enrolled to TLS-CA ###############"
echo "#################################################################"
echo "                                                                 "
